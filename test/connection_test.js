var vows        = require('vows'),
    ...
    connection  = require('../lib/abramo/connection'),
...
vows.describe('Response').addBatch({
  "should save data if http method is PUT" : function() {
    ...
    var c = new connection.Connection(s, fakeHttpRequest, {});
  ...
  "should call get on store" : function() {
    ...
    var c = new connection.Connection(fakeStore, fakeHttpRequest, fakeHttpResponse);
